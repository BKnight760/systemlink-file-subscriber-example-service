# -*- coding: utf-8 -*-
"""
Implementation of the FileSubscriberExampleService class.
"""
...
from systemlink.filesubscriberexampleservice import error_codes
from systemlink.filesubscriberexampleservice import loader
# pylint: enable=import-error

# Set up logging
LOGGER = logging.getLogger(__name__)

ERROR_CATEGORY = 'FileSubscriberExample'
PLUGIN_CATEGORY_HANDLERS = 'handlers'


class FileSubscriberExampleService(ManagedServiceBase):
    """
    Class to publicly access the File Subscriber Example Service.
    """
    def __init__(self, service_name: str, standalone: bool = False):
        ...
        try:
            ...
            LOGGER.error(
                'Failed to initialize the File Subscriber Example Service. %s: %s',
    ...
    def close(self):  # pylint: disable=useless-super-delegation
        """
        Close the FileSubscriberExampleService and all associated resources.
        """
        super().close()
    ...
    def config(self) -> Dict[str, str]:
        """
        Get the File Subscriber Example Service configuration.
