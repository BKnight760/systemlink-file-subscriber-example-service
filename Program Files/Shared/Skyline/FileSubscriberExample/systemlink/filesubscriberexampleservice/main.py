# -*- coding: utf-8 -*-
"""
Command line actions for the File Subscriber Example.
"""
...
from systemlink.filesubscriberexampleservice.managed_service import FileSubscriberExampleService
...
SERVICE_NAME = 'FileSubscriberExample'
...
def run_service(standalone, silent=False):
    ...
    """
    try:
        with FileSubscriberExampleService(service_name=SERVICE_NAME, standalone=standalone) as service:
        ...
        if not silent:
            print('File Subscriber Example has stopped.')
    return 0
